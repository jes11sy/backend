...
class TestAPIEndpointsExtended:
    ...
    def test_pagination_handling(self):
        ...
        pagination_params = {"page": 1, "limit": 10, "total": 100}
        ...
        total_pages = (
            pagination_params["total"] + pagination_params["limit"] - 1
...
class TestCacheOperations:
    ...
    async def test_cache_patterns(self):
        ...
        result = await cache_manager.get_or_set(
            "expensive_key", expensive_operation, ttl=600
        )
...
class TestMetricsCollection:
    ...
    def test_metrics_aggregation(self):
        ...
        metrics_aggregator.get_stats = Mock(
            return_value={"count": 100, "avg": 0.5, "min": 0.1, "max": 2.0, "p95": 1.5}
        )
