...
class TestPasswordSecurity:
    ...
    def test_password_strength_requirements(self):
        ...
        # Слабые пароли
        weak_passwords = ["123", "password", "12345678", "qwerty", "admin"]
...
class TestFileSecurityValidation:
    ...
    async def test_file_type_validation(
        self, authenticated_client: TestClient, test_request
    ):
    ...
    async def test_file_content_validation(
        self, mock_validate, authenticated_client: TestClient, test_request
    ):
