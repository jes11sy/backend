...
class GrafanaDashboardGenerator:
        ...
        dashboard["dashboard"].update(
            {
                ...
                "panels": [
                    ...
                    # Redis Connections
                    {
                        ...
                        "type": "stat",
                        "targets": [
                            {"expr": "redis_connections", "legendFormat": "Connections"}
                        ],
                        "fieldConfig": {
                            "defaults": {
                                "color": {"mode": "palette-classic"},
        ...
        dashboard["dashboard"].update(
            {
                ...
                "panels": [
                    # Total Requests
                    {
                        ...
                        "type": "stat",
                        "targets": [
                            {"expr": "requests_total", "legendFormat": "Total"}
                        ],
                        "fieldConfig": {
                            "defaults": {
                                "color": {"mode": "palette-classic"},
                    ...
                    # Requests by Status
                    {
                        ...
                        "type": "piechart",
                        "targets": [
                            {"expr": "requests_total", "legendFormat": "{{status}}"}
                        ],
                        "fieldConfig": {
                            "defaults": {
                                "color": {"mode": "palette-classic"},
                    ...
                    # Transactions
                    {
                        ...
                        "type": "stat",
                        "targets": [
                            {"expr": "transactions_total", "legendFormat": "Total"}
                        ],
                        "fieldConfig": {
                            "defaults": {
                                "color": {"mode": "palette-classic"},
                    ...
                    # Active Users
                    {
                        ...
                        "type": "stat",
                        "targets": [
                            {"expr": "active_users", "legendFormat": "{{role}}"}
                        ],
                        "fieldConfig": {
                            "defaults": {
                                "color": {"mode": "palette-classic"},
    ...
    def save_dashboards_to_files(self, output_dir: str = "grafana_dashboards"):
        ...
        instructions = {
            "setup_instructions": {
                "prometheus": {"url": "http://localhost:8001/metrics", "port": 8001},
                "grafana": {
...
def main():
    ...
    print("\n📋 Next steps:")
    print(
        "1. Install Prometheus and configure it to scrape metrics from http://localhost:8001/metrics"
    )
