...
class AlertingSystem:
        ...
        self.add_alert_rule(
            AlertRule(
                ...
                annotations={
                    ...
                    "description": "System may be underutilized",
                },
            )
        )
        ...
        self.add_alert_rule(
            AlertRule(
                ...
                annotations={
                    ...
                    "description": "Cache performance is poor",
                },
            )
        )
    ...
    def create_default_notification_channels(self):
        ...
        self.add_notification_channel(
            NotificationChannel(name="EmailAlerts", type="email", config=email_config)
        )
        ...
        self.add_notification_channel(
            NotificationChannel(name="SlackAlerts", type="slack", config=slack_config)
        )
        ...
        self.add_notification_channel(
            NotificationChannel(
                name="WebhookAlerts", type="webhook", config=webhook_config
            )
        )
    ...
    def check_alert_condition(
        self, rule: AlertRule, metrics_data: Dict[str, float]
    ) -> bool:
        ...
        try:
            ...
            if rule.condition == "cpu_usage_percent > 80":
                ...
                return (
                    metrics_data.get("memory_usage_bytes", 0) / 1024 / 1024 / 1024
                ) > 8
    ...
    def save_configuration(self, filename: str = "alerting_config.json"):
        ...
        config = {
            ...
            "notification_channels": [
                {"name": channel.name, "type": channel.type, "config": channel.config}
                for channel in self.notification_channels
            ],
        }
