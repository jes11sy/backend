...
class PrometheusMetrics:
    ...
    def __init__(self):
        ...
        self.active_users = Gauge(
            "active_users", "Number of active users", ["role"], registry=self.registry
        )
...
class SystemMetricsCollector:
    ...
    async def collect_system_metrics(self):
        ...
        try:
            ...
            logger.info(
                f"System metrics collected: CPU {cpu_percent}%, Memory {memory.used / 1024 / 1024:.1f}MB"
            )
...
class PrometheusExporter:
    ...
    async def health_handler(self, request):
        ...
        return web.Response(
            body=json.dumps(health_data), content_type="application/json"
        )
    ...
    async def stats_handler(self, request):
        ...
        return web.Response(
            body=json.dumps(stats_data), content_type="application/json"
        )
