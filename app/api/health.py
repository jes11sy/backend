...
class HealthChecker:
    ...
    async def check_database(self) -> HealthCheckResult:
        ...
        try:
            ...
            return HealthCheckResult(
                "database", "healthy", "Database is operational", details, duration
            )
    ...
    async def check_cache(self) -> HealthCheckResult:
        ...
        try:
            ...
            details = {
                ...
                "cache_info": (
                    cache_info if asyncio.iscoroutine(cache_info) else cache_info
                ),
            }

            return HealthCheckResult(
                "cache", "healthy", "Cache is operational", details, duration
            )
    ...
    async def check_system_resources(self) -> HealthCheckResult:
        ...
        try:
            ...
            return HealthCheckResult(
                "system", "healthy", "System resources are normal", details, duration
            )
    ...
    async def check_metrics(self) -> HealthCheckResult:
        ...
        try:
            ...
            details = {
                ...
                "background_task_active": metrics_collector._background_task is not None
                and not metrics_collector._background_task.done(),
            }
    ...
    async def run_all_checks(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "summary": {
                ...
                "degraded": len(
                    [c for c in checks.values() if c["status"] == "degraded"]
                ),
                "unhealthy": len(
