...
class FileAuditLogger:
    ...
    @staticmethod
    async def log_file_access(db: AsyncSession, event: FileAccessEvent):
    ...
    @staticmethod
    async def get_access_statistics(db: AsyncSession, days: int = 30) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "success_rate": (
                    (successful_accesses / total_accesses * 100)
                    if total_accesses > 0
                    else 0
                ),
                "top_users": top_users,
