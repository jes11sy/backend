...
class Request(Base):
    ...
    advertising_campaign = relationship(
        "AdvertisingCampaign", back_populates="requests", lazy="select"
    )
...
class Transaction(Base):
    ...
    transaction_type = relationship(
        "TransactionType", back_populates="transactions", lazy="select"
    )
...
class File(Base):
    ...
    )  # bso, expense, recording, transaction
