...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_transactions_transaction_type_id", "transactions", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "fk_requests_advertising_campaign_id", "requests", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_administrators_role_id", "administrators", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "fk_advertising_campaigns_city_id", "advertising_campaigns", type_="foreignkey"
    )
