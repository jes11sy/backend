...
def main():
    ...
    parser.add_argument(
        "--unit", action="store_true", help="Запустить только unit тесты"
    )
    parser.add_argument(
        "--integration", action="store_true", help="Запустить только integration тесты"
    )
    parser.add_argument(
        "--auth", action="store_true", help="Запустить только тесты аутентификации"
    )
    parser.add_argument("--api", action="store_true", help="Запустить только тесты API")
    parser.add_argument(
        "--models", action="store_true", help="Запустить только тесты моделей"
    )
    parser.add_argument(
        "--coverage", action="store_true", help="Запустить с покрытием кода"
    )
    parser.add_argument("--verbose", "-v", action="store_true", help="Подробный вывод")
    parser.add_argument(
        "--parallel", "-p", action="store_true", help="Параллельный запуск тестов"
    )
