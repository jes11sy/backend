...
class SimpleMigrationManager:
    ...
    def run_alembic_command(self, command: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = safe_subprocess_run(full_command, cwd=self.base_dir)
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "history_output": (
                history_result["stdout"] if history_result["success"] else None
            ),
        }
