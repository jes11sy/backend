...
class AdvancedTestRunner:
    ...
    def run_e2e_tests(self) -> Dict[str, Any]:
        ...
        result = self.run_command(cmd, "E2E тесты пользовательских сценариев", timeout=600)
    ...
    def run_chaos_tests(self) -> Dict[str, Any]:
        ...
        result = self.run_command(cmd, "Chaos Engineering тесты отказоустойчивости", timeout=800)
    ...
    def generate_report(self) -> str:
        ...
        report.append(f"⏱️ Общая продолжительность: {self.results['total_duration']:.2f} секунд")
...
def main():
    ...
    parser.add_argument(
        "--report",
        default="advanced_test_report.txt",
